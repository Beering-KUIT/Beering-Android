...
import com.example.beering.feature.review.ReviewSelectedOptions
...
class ReviewWritingActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                if(response.isSuccessful) {
                    ...
                    if (resp!!.isSuccess) {
                        ...
                        binding.reviewWritingRating1Rb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            binding.reviewWritingRating1Mcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
                        binding.reviewWritingRating2Rb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            reviewratingList.add(rating)
                            RbCheckedList[1] = true
                            binding.reviewWritingRating2Mcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
                        binding.reviewWritingRating3Rb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            reviewratingList.add(rating)
                            RbCheckedList[2] = true
                            binding.reviewWritingRating3Mcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
                        binding.reviewWritingRating4Rb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            reviewratingList.add(rating)
                            RbCheckedList[3] = true
                            binding.reviewWritingRating4Mcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
                        binding.reviewWritingRating5Rb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            reviewratingList.add(rating)
                            RbCheckedList[4] = true
                            binding.reviewWritingRating5Mcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
                        ...
                        binding.reviewWritingRatingTotalRb.setOnRatingChangeListener { ratingBar, rating, fromUser ->
                            ...
                            binding.reviewWritingRatingTotalMcv.setCardBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                                R.color.black
                            ))
                            isButtonEanble()
                        }
        ...
        binding.reviewWritingPictureOffIv.setOnClickListener {
            ...
            // 사진마다(item마다) 삭제버튼 적용
            reviewPictureAdapter!!.setOnCancelClickListener(object :
                ReviewPictureAdapter.OnCancelClickListener {
    ...
    fun isButtonEanble(){
        if(binding.reviewWritingImpressionEd.text.isNotEmpty() && RbCheckedList.all { it })
        {
            ...
            binding.reviewWritingCompleteButtonCl.setBackgroundColor(ContextCompat.getColor(this@ReviewWritingActivity,
                R.color.black
            ))
